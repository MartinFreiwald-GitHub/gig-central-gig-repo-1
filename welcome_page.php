...
<div class="column col-lg-12 col-sm-12 col-xs-12">
        <div class="inner-column">
             <h2>Welcome!</h2>
            <p>Welcome to Gig Central, where students and employers connect! New to the site? Click here for more!</p>
    ...
    <a href="<?php echo base_url().'gig'; ?>">
        ...
        <div class="inner-box">
            ...
            <h3>Find a Gig</h3>
            <div class="bar"></div>
            <p>For students and alumni looking for local job opportunities</p>
        </div></div>
    </a>
    ...
    <a href="<?php echo base_url().'gig/add'; ?>">
        ...
        <div class="inner-box">
            ...
            <h3>Post a Gig</h3>
            <div class="bar"></div>
            <p>For local employers in need of development talent</p>
        </div></div>
    </a>
...
// this was for the 'Profile Pictures section on the page'
